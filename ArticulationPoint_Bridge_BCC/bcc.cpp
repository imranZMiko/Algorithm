...
/*
Basically, if articulation point is found, not a bcc. IF not found, then it will be a bcc
...
/*
Basically maintain a stack of edges, and when an articulation point is reached, it will be understood that it is a bcc and pop from the stack.
